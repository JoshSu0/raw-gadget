...
//josh+	EP_INFO("ep1out-bulk",
//josh+		USB_EP_CAPS(USB_EP_CAPS_TYPE_BULK, USB_EP_CAPS_DIR_OUT)),
//josh+	EP_INFO("ep2in-bulk",
//josh+		USB_EP_CAPS(USB_EP_CAPS_TYPE_BULK, USB_EP_CAPS_DIR_IN)),
